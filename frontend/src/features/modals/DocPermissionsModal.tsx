...
const styles = {
  ...
  errorText: 'mt-1 flex items-center gap-1.5 text-body text-semantic-error',
  lbl: 'mt-5 mb-1 text-label text-primary',
  people: 'flex flex-col max-h-[350px] overflow-auto',
  prow: 'flex items-center gap-3 py-2',
  who: 'flex-1 min-w-0',
  nm: 'flex items-center gap-1.5 text-label text-primary truncate',
  sub: 'text-body text-secondary truncate',
  ...
  linkT: 'text-label text-primary',
  linkD: 'mt-0.5 text-body text-secondary',
  linkRow: 'mt-3 flex items-center gap-2',
  permRow: 'mt-3.5 flex items-center gap-2 flex-wrap',
  warn: 'mt-2 flex items-center gap-1.5 text-body text-semantic-warning',
  alertWrap: 'mt-3',
  footNote: 'flex items-center gap-1.5 text-label text-secondary',
};
