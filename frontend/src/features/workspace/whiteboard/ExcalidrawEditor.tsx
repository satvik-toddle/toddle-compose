...
// Real-time collaborative whiteboard (WHITEBOARD_EXCALIDRAW page type): binds the
// Excalidraw canvas to Yjs via y-excalidraw. Keyed by docId at the call site; the
// RTC role drives editability (viewers get a read-only canvas).
export function ExcalidrawEditor({ docId }: Readonly<WhiteboardEditorProps>) {
